package com.xontel.surveillancecameras.hikSDK;
...
//    }
//
//    public HikvisionSdk(SurfaceView surfaceView, Context context )
//    {
...
//        else
//        {
//            ((TestActivity)context).hideProgressView();
...
//
//            ((TestActivity)context).runOnUiThread(new Runnable()
//            {
//                @Override
//                public void run()
//                {
...
//                    return;
//                }
//                if(!hikvisionPlayer.play(playPort, surfaceView.getHolder().getSurface()))
//                {
...
//            CameraInfo.password = "X0nPAssw0rd_000";
////            if(!evercamCamera.getExternalHost().isEmpty())
////            {
//                CameraInfo.ip = "192.168.1.123";
//                CameraInfo.sdkPort = 8000;
////            }
