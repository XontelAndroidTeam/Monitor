...
public abstract class XontelFragmentStatePagerAdapter extends PagerAdapter {
     ...
     * @see #XontelFragmentStatePagerAdapter(FragmentManager, int)
     */
    @Deprecated
     ...
     * {@link #XontelFragmentStatePagerAdapter(FragmentManager, int)} and passing in
     ...
     * @deprecated use {@link #XontelFragmentStatePagerAdapter(FragmentManager, int)} with
     * {@link #BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT}
     */
    @Deprecated
    public XontelFragmentStatePagerAdapter(@NonNull FragmentManager fm) {
