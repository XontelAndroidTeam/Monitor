...
public class VideoHelper implements IVLCVout.OnNewVideoLayoutListener {
    ...
    public VideoHelper(View viewHolder, LibVLC mLibVLC, MediaPlayer mMediaPlayer, int video_surface_frame, int surface_stub, int subtitles_surface_stub, int texture_stub) {
